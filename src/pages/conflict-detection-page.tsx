...
function badgeVariant(
  v?: string | null
): "rose" | "amber" | "emerald" | "slate" | "violet" | "blue" | "dark" {
...
function DocumentPanel({ contractId }: { contractId: string }) {
  ...
  return (
    <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm dark:border-white/10 dark:bg-white/5">
      <div className="flex items-center justify-between gap-3 border-b border-slate-100 bg-slate-50 px-5 py-3 dark:border-white/10 dark:bg-white/5">
    ...
    <AppCard tone="soft">
      <div className="mb-5">
        <h2 className="flex items-center gap-2 text-xl font-semibold text-slate-900 dark:text-white">
          <Workflow className="h-5 w-5 text-slate-500 dark:text-slate-400" />
          Workflow
        </h2>
      </div>
      ...
      <div className="space-y-4">
        ...
        {!latest ? (
          ...
          <>
            ...
            <div className="rounded-xl border border-slate-100 bg-slate-50 px-3 py-2 dark:border-white/10 dark:bg-white/5">
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    ...
                    <Button
                      ...
                      onClick={() =>
                        handleVote(latest.id, "changes_requested")
                      }
                      disabled={voting === latest.id}
                    >
              ...
              <div>
                ...
                <div className="space-y-1.5">
                  {latest.approvers.map((a, i) => (
                    <div
                      key={i}
                      className="flex items-center justify-between rounded-xl border border-slate-100 px-3 py-2 dark:border-white/10"
                    >
